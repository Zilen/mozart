...
public class Chorale {
	public static void main(String[] args){
		...
		// create jMusic parts
		Part s = new Part("Soprano",  jm.constants.ProgramChanges.OOH, 1);
		Part a = new Part("Alto",  jm.constants.ProgramChanges.AAH, 2);
		Part t = new Part("Tenor",  jm.constants.ProgramChanges.OOH, 3);
		Part b = new Part("Bass",  jm.constants.ProgramChanges.AAH, 4);
