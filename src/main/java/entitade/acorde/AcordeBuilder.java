...
public class AcordeBuilder {
	...
	public static Acorde build(Escala escala, Nota nota) throws AcordeInvalidoException {
		return build(escala, nota, null);
	}
	public static Acorde build(Escala escala, Nota nota, TipoAcorde tipoAcorde) throws AcordeInvalidoException {
